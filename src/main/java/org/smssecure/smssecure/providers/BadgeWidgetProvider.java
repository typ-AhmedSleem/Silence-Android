...
public class BadgeWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(final Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int widgetId : appWidgetIds) {
            ...
            if (unreadCount <= 0) {
                ...
                String displayCount = (unreadCount <= MAX_COUNT) ? String.valueOf(unreadCount) : MAX_COUNT + "+";
    ...
    public void updateBadge(int unreadCount) {
        ...
        if (unreadCount <= 0) {
            ...
            String displayCount = unreadCount <= BadgeWidgetProvider.MAX_COUNT ? String.valueOf(unreadCount) : MAX_COUNT + "+";
            remoteViews.setTextViewText(R.id.widget_number, displayCount);
        }
