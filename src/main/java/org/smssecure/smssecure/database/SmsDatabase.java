...
public class SmsDatabase extends MessagingDatabase {
    ...
    protected Pair<Long, Long> updateMessageBodyAndType(long messageId, String body, long maskOff, long maskOn) {
        ...
        db.execSQL("UPDATE " + TABLE_NAME + " SET " + BODY + " = ?, " +
                        ...
                        "WHERE " + ID + " = ?",
                new String[]{body, String.valueOf(messageId)});
    ...
    protected Pair<Long, Long> insertMessageInbox(IncomingTextMessage message, long type) {
        if (message.isKeyExchange()) {
            ...
            if (((IncomingKeyExchangeMessage) message).isStale())
                type |= Types.KEY_EXCHANGE_STALE_BIT;
                ...
                type |= Types.KEY_EXCHANGE_BUNDLE_BIT;
...
//      type |= Types.ENCRYPTION_REMOTE_BIT;
    ...
    public Cursor getMessage(long messageId) {
        SQLiteDatabase db = databaseHelper.getReadableDatabase();
        Cursor cursor = db.query(TABLE_NAME, MESSAGE_PROJECTION, ID_WHERE, new String[]{String.valueOf(messageId)},
                null, null, null);
    ...
    public boolean deleteMessage(long messageId) {
        ...
        SQLiteDatabase db = databaseHelper.getWritableDatabase();
        long threadId = getThreadIdForMessage(messageId);
        db.delete(TABLE_NAME, ID_WHERE, new String[]{String.valueOf(messageId)});
    ...
    /*package*/void deleteMessagesInThreadBeforeDate(long threadId, long date) {
        ...
        db.delete(TABLE_NAME, where.toString(), new String[]{String.valueOf(threadId)});
    }
