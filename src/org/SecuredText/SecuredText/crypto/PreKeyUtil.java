...
package org.SecuredText.SecuredText.crypto;
...
import org.SecuredText.SecuredText.crypto.storage.SecuredTextPreKeyStore;
...
public class PreKeyUtil {
  ...
  private static File getPreKeysDirectory(Context context) {
    return getKeysDirectory(context, SecuredTextPreKeyStore.PREKEY_DIRECTORY);
  }

  private static File getSignedPreKeysDirectory(Context context) {
    return getKeysDirectory(context, SecuredTextPreKeyStore.SIGNED_PREKEY_DIRECTORY);
  }
