...
import org.SecuredText.SecuredText.database.documents.NetworkFailureList;
import org.SecuredText.SecuredText.database.documents.IdentityKeyMismatch;
import org.SecuredText.SecuredText.database.documents.IdentityKeyMismatchList;
import org.SecuredText.SecuredText.database.model.DisplayRecord;
...
import org.SecuredText.SecuredText.jobs.TrimThreadJob;
...
import org.SecuredText.SecuredText.mms.PartParser;
import org.SecuredText.SecuredText.mms.SlideDeck;
import org.SecuredText.SecuredText.mms.TextSlide;
...
import org.SecuredText.SecuredText.util.JsonUtils;
import org.SecuredText.SecuredText.util.LRUCache;
...
import static org.SecuredText.SecuredText.util.Util.canonicalizeNumber;
import static org.SecuredText.SecuredText.util.Util.canonicalizeNumberOrGroup;
...
public class MmsDatabase extends MessagingDatabase {
  ...
  public static final ExecutorService slideResolver = org.SecuredText.SecuredText.util.Util.newSingleThreadedLifoExecutor();
      ...
      throws MmsException
  {
    ...
    boolean       unread        = org.SecuredText.SecuredText.util.Util.isDefaultSmsProvider(context) ||
  ...
  public Pair<Long, Long> insertMessageInbox(NotificationInd notification) {
    try {
      ...
      contentValues.put(STATUS, Status.DOWNLOAD_INITIALIZED);
      contentValues.put(DATE_RECEIVED, System.currentTimeMillis() / 1000);
      contentValues.put(READ, org.SecuredText.SecuredText.util.Util.isDefaultSmsProvider(context) ? 0 : 1);
...
//      Trimmer.trimThread(context, threadId);
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.SecuredText.SecuredText.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).setUnread(threadId);
    }
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.SecuredText.SecuredText.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.SecuredText.SecuredText.util.Util.toIsoBytes(transactionId);
