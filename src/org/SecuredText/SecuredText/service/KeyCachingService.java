...
import org.SecuredText.SecuredText.DatabaseUpgradeActivity;
import org.SecuredText.SecuredText.DummyActivity;
import org.SecuredText.SecuredText.R;
import org.SecuredText.SecuredText.RoutingActivity;
import org.SecuredText.SecuredText.crypto.InvalidPassphraseException;
...
import org.SecuredText.SecuredText.util.ParcelUtil;
...
public class KeyCachingService extends Service {
  ...
  public  static final String KEY_PERMISSION           = "org.SecuredText.SecuredText.ACCESS_SECRETS";
  public  static final String NEW_KEY_EVENT            = "org.SecuredText.SecuredText.service.action.NEW_KEY_EVENT";
  public  static final String CLEAR_KEY_EVENT          = "org.SecuredText.SecuredText.service.action.CLEAR_KEY_EVENT";
  private static final String PASSPHRASE_EXPIRED_EVENT = "org.SecuredText.SecuredText.service.action.PASSPHRASE_EXPIRED_EVENT";
  public  static final String CLEAR_KEY_ACTION         = "org.SecuredText.SecuredText.service.action.CLEAR_KEY";
  public  static final String DISABLE_ACTION           = "org.SecuredText.SecuredText.service.action.DISABLE";
  public  static final String ACTIVITY_START_EVENT     = "org.SecuredText.SecuredText.service.action.ACTIVITY_START_EVENT";
  public  static final String ACTIVITY_STOP_EVENT      = "org.SecuredText.SecuredText.service.action.ACTIVITY_STOP_EVENT";
  public  static final String LOCALE_CHANGE_EVENT      = "org.SecuredText.SecuredText.service.action.LOCALE_CHANGE_EVENT";
  ...
  public static synchronized MasterSecret getMasterSecret(Context context) {
    if (masterSecret == null && SecuredTextPreferences.isPasswordDisabled(context)) {
      try {
  ...
  private void startTimeoutIfAppropriate() {
    boolean timeoutEnabled = SecuredTextPreferences.isPassphraseTimeoutEnabled(this);

    if ((activitiesRunning == 0) && (this.masterSecret != null) && timeoutEnabled && !SecuredTextPreferences.isPasswordDisabled(this)) {
      long timeoutMinutes = SecuredTextPreferences.getPassphraseTimeoutInterval(this);
