...
import org.SecuredText.SecuredText.jobs.DirectoryRefreshJob;
...
public class DirectoryRefreshListener extends BroadcastReceiver {
  ...
  public static void schedule(Context context) {
    ...
    long              time          = SecuredTextPreferences.getDirectoryRefreshTime(context);
    ...
    SecuredTextPreferences.setDirectoryRefreshTime(context, time);
  }
