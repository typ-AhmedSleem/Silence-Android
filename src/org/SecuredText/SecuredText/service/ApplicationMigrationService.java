...
import org.SecuredText.SecuredText.database.SmsMigrator;
import org.SecuredText.SecuredText.database.SmsMigrator.ProgressDescription;
...
public class ApplicationMigrationService extends Service
  ...
  public  static final String MIGRATE_DATABASE  = "org.SecuredText.SecuredText.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "org.SecuredText.SecuredText.ApplicationMigrationService.COMPLETED";
  ...
  private class CompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      builder.setContentText("SecuredText system database import is complete.");
