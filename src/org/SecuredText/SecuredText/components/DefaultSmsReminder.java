...
public class DefaultSmsReminder extends Reminder {
  ...
  public DefaultSmsReminder(final Context context) {
    ...
    final OnClickListener okListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        SecuredTextPreferences.setPromptedDefaultSmsProvider(context, true);
  ...
  public static boolean isEligible(Context context) {
    ...
    if (isDefault) {
      SecuredTextPreferences.setPromptedDefaultSmsProvider(context, false);
    }

    return !isDefault && !SecuredTextPreferences.hasPromptedDefaultSmsProvider(context);
  }
}
