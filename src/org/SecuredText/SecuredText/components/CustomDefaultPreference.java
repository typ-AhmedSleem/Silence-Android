...
public class CustomDefaultPreference extends DialogPreference {
  ...
  private boolean isCustom() {
    return SecuredTextPreferences.getBooleanPreference(getContext(), customToggle, false);
  }

  private void setCustom(boolean custom) {
    SecuredTextPreferences.setBooleanPreference(getContext(), customToggle, custom);
  }

  private String getCustomValue() {
    return SecuredTextPreferences.getStringPreference(getContext(), customPreference, "");
  }

  private void setCustomValue(String value) {
    SecuredTextPreferences.setStringPreference(getContext(), customPreference, value);
  }
