...
public class MmsAddressDatabase extends Database {
    ...
    public MmsAddresses getAddressesForId(long messageId) {
        ...
        try {
            cursor = database.query(TABLE_NAME, null, MMS_ID + " = ?", new String[]{String.valueOf(messageId)}, null, null, null);
    ...
    public void deleteAddressesForId(long messageId) {
        SQLiteDatabase database = databaseHelper.getWritableDatabase();
        database.delete(TABLE_NAME, MMS_ID + " = ?", new String[]{String.valueOf(messageId)});
    }
