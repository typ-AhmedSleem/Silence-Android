...
public class StoragePreferenceFragment extends PreferenceFragment {
  ...
  public void onCreate(Bundle paramBundle) {
    ...
    this.findPreference(SMSSecurePreferences.THREAD_TRIM_NOW)
      .setOnPreferenceClickListener(new TrimNowClickListener());
    this.findPreference(SMSSecurePreferences.THREAD_TRIM_LENGTH)
  ...
  public static CharSequence getSummary(Context context) {
    ...
    return context.getString(SMSSecurePreferences.isThreadLengthTrimmingEnabled(context) ? onCapsResId : offCapsResId);
  }
}
