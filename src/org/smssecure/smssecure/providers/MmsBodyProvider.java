...
public class MmsBodyProvider extends ContentProvider {
    ...
    private static final String CONTENT_URI_STRING = "content://org.smssecure.provider.smssecure.mms/mms";
    ...
    static {
        ...
        uriMatcher.addURI("org.smssecure.provider.smssecure.mms", "mms/#", SINGLE_ROW);
    }
