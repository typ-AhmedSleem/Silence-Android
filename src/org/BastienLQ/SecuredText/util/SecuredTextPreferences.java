...
public class SecuredTextPreferences {

  private static final String TAG = SecuredTextPreferences.class.getSimpleName();
  ...
  public static boolean getUseCustomMmsc(Context context) {
    boolean legacy = SecuredTextPreferences.isLegacyUseLocalApnsEnabled(context);
  ...
  public static void setPushRegistered(Context context, boolean registered) {
    Log.w("SecuredTextPreferences", "Setting push registered: " + registered);
