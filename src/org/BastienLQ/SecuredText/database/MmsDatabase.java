...
import org.BastienLQ.SecuredText.database.documents.NetworkFailure;
import org.BastienLQ.SecuredText.database.documents.NetworkFailureList;
import org.BastienLQ.SecuredText.database.documents.IdentityKeyMismatch;
import org.BastienLQ.SecuredText.database.documents.IdentityKeyMismatchList;
import org.BastienLQ.SecuredText.database.model.DisplayRecord;
import org.BastienLQ.SecuredText.database.model.MediaMmsMessageRecord;
import org.BastienLQ.SecuredText.database.model.MessageRecord;
import org.BastienLQ.SecuredText.database.model.NotificationMmsMessageRecord;
import org.BastienLQ.SecuredText.jobs.TrimThreadJob;
import org.BastienLQ.SecuredText.mms.IncomingMediaMessage;
import org.BastienLQ.SecuredText.mms.OutgoingGroupMediaMessage;
import org.BastienLQ.SecuredText.mms.OutgoingMediaMessage;
import org.BastienLQ.SecuredText.mms.PartParser;
import org.BastienLQ.SecuredText.mms.SlideDeck;
import org.BastienLQ.SecuredText.mms.TextSlide;
...
import org.BastienLQ.SecuredText.util.JsonUtils;
import org.BastienLQ.SecuredText.util.LRUCache;
import org.BastienLQ.SecuredText.util.ListenableFutureTask;
...
import static org.BastienLQ.SecuredText.util.Util.canonicalizeNumber;
import static org.BastienLQ.SecuredText.util.Util.canonicalizeNumberOrGroup;
...
public class MmsDatabase extends MessagingDatabase {
  ...
  public static final ExecutorService slideResolver = org.BastienLQ.SecuredText.util.Util.newSingleThreadedLifoExecutor();
  ...
  private long getThreadIdFor(IncomingMediaMessage retrieved) throws RecipientFormattingException, MmsException {
    ...
    try {
      ...
      if (localNumber == null) {
          localNumber = SecuredTextPreferences.getLocalNumber(context);
      }
      ...
      throws MmsException
  {
    ...
    boolean       unread        = org.BastienLQ.SecuredText.util.Util.isDefaultSmsProvider(context) ||
  ...
  public Pair<Long, Long> insertMessageInbox(NotificationInd notification) {
    try {
      ...
      contentValues.put(STATUS, Status.DOWNLOAD_INITIALIZED);
      contentValues.put(DATE_RECEIVED, System.currentTimeMillis() / 1000);
      contentValues.put(READ, org.BastienLQ.SecuredText.util.Util.isDefaultSmsProvider(context) ? 0 : 1);
...
//      Trimmer.trimThread(context, threadId);
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.BastienLQ.SecuredText.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).setUnread(threadId);
    }
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.BastienLQ.SecuredText.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.BastienLQ.SecuredText.util.Util.toIsoBytes(transactionId);
