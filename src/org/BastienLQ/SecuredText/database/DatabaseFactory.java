...
import org.BastienLQ.SecuredText.crypto.DecryptingPartInputStream;
...
public class DatabaseFactory {
                                        ...
                                        DatabaseUpgradeActivity.DatabaseUpgradeListener listener)
  {
    ...
    if (fromVersion < DatabaseUpgradeActivity.NO_MORE_KEY_EXCHANGE_PREFIX_VERSION) {
      String KEY_EXCHANGE             = "?SecuredTextKeyExchange";
      String PROCESSED_KEY_EXCHANGE   = "?SecuredTextKeyExchangd";
      String STALE_KEY_EXCHANGE       = "?SecuredTextKeyExchangs";
      int ROW_LIMIT                   = 500;
  ...
  private static class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
      ...
      if (oldVersion < INTRODUCED_NEW_TYPES_VERSION) {
        String KEY_EXCHANGE             = "?SecuredTextKeyExchange";
        String SYMMETRIC_ENCRYPT        = "?SecuredTextLocalEncrypt";
        String ASYMMETRIC_ENCRYPT       = "?SecuredTextAsymmetricEncrypt";
        String ASYMMETRIC_LOCAL_ENCRYPT = "?SecuredTextAsymmetricLocalEncrypt";
        String PROCESSED_KEY_EXCHANGE   = "?SecuredTextKeyExchangd";
        String STALE_KEY_EXCHANGE       = "?SecuredTextKeyExchangs";
