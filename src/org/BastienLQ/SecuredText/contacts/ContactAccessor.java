 ...
 */
package org.BastienLQ.SecuredText.contacts;
...
public class ContactAccessor {
  ...
  public Collection<ContactData> getContactsWithPush(Context context) {
    ...
    List<String> pushNumbers = SecuredTextDirectory.getInstance(context).getActiveNumbers();
    ...
    for (String pushNumber : pushNumbers) {
      ...
      try {
        if (lookupCursor != null && lookupCursor.moveToFirst()) {
          ...
          contactData.numbers.add(new NumberData("SecuredText", pushNumber));
