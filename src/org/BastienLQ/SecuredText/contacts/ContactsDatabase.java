...
/**
 * Database to supply all types of contacts that SecuredText needs to know about
 *
 * @author Jake McGinty
 */
public class ContactsDatabase {
  ...
  public Cursor query(String filter, boolean pushOnly) {
    final boolean      includeAndroidContacts = !pushOnly && SecuredTextPreferences.isDirectSmsAllowed(context);
