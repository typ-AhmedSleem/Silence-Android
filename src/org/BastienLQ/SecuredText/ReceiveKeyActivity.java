...
import org.BastienLQ.SecuredText.crypto.IdentityKeyParcelable;
...
import org.BastienLQ.SecuredText.database.IdentityDatabase;
import org.BastienLQ.SecuredText.database.PushDatabase;
import org.BastienLQ.SecuredText.jobs.PushDecryptJob;
import org.BastienLQ.SecuredText.jobs.SmsDecryptJob;
import org.BastienLQ.SecuredText.recipients.Recipient;
import org.BastienLQ.SecuredText.recipients.RecipientFactory;
import org.BastienLQ.SecuredText.sms.IncomingIdentityUpdateMessage;
import org.BastienLQ.SecuredText.sms.IncomingKeyExchangeMessage;
import org.BastienLQ.SecuredText.sms.IncomingPreKeyBundleMessage;
...
public class ReceiveKeyActivity extends BaseActivity {
  ...
  private boolean isTrusted(IdentityKey identityKey) {
    IdentityKeyStore identityKeyStore = new SecuredTextIdentityKeyStore(this, masterSecret);
