...
import org.BastienLQ.SecuredText.service.RegistrationService;
...
import static org.BastienLQ.SecuredText.service.RegistrationService.RegistrationState;
    ...
    public void onClick(View v) {
      ...
      new AsyncTask<Void, Void, Integer>() {
        ...
        protected Integer doInBackground(Void... params) {
          try {
            TextSecureAccountManager accountManager = SecuredTextCommunicationFactory.createManager(context, e164number, password);
            int registrationId = SecuredTextPreferences.getLocalRegistrationId(context);
