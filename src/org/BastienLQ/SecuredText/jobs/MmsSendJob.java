...
import org.BastienLQ.SecuredText.crypto.MmsCipher;
...
import org.BastienLQ.SecuredText.mms.ApnUnavailableException;
import org.BastienLQ.SecuredText.mms.MediaConstraints;
import org.BastienLQ.SecuredText.mms.MmsRadio;
import org.BastienLQ.SecuredText.mms.MmsRadioException;
import org.BastienLQ.SecuredText.mms.MmsSendResult;
...
import org.BastienLQ.SecuredText.transport.InsecureFallbackApprovalException;
import org.BastienLQ.SecuredText.transport.UndeliverableMessageException;
import org.BastienLQ.SecuredText.util.Hex;
import org.BastienLQ.SecuredText.util.NumberUtil;
import org.BastienLQ.SecuredText.util.TelephonyUtil;
...
public class MmsSendJob extends SendJob {
  ...
  {
    try {
      MmsCipher cipher = new MmsCipher(new SecuredTextAxolotlStore(context, masterSecret));
