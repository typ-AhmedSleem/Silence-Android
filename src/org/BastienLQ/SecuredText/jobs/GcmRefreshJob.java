...
import org.BastienLQ.SecuredText.PlayServicesProblemActivity;
...
public class GcmRefreshJob extends ContextJob {
  ...
  public void onRun() throws Exception {
    ...
    String                   registrationId = SecuredTextPreferences.getGcmRegistrationId(context);
    ...
    if (registrationId == null) {
      ...
      if (result != ConnectionResult.SUCCESS) {
        ...
        SecuredTextPreferences.setGcmRegistrationId(context, gcmId);
        SecuredTextPreferences.setWebsocketRegistered(context, true);
      }
    }
  }
  ...
  private void notifyGcmFailure() {
    ...
    builder.setContentTitle(context.getString(R.string.GcmRefreshJob_Permanent_SecuredText_communication_failure));
    builder.setContentText(context.getString(R.string.GcmRefreshJob_SecuredText_was_unable_to_register_with_Google_Play_Services));
    builder.setTicker(context.getString(R.string.GcmRefreshJob_Permanent_SecuredText_communication_failure));
