...
public class TrimThreadJob extends Job {
  ...
  @Override
  public void onRun() {
    boolean trimmingEnabled   = SecuredTextPreferences.isThreadLengthTrimmingEnabled(context);
    int     threadLengthLimit = SecuredTextPreferences.getThreadTrimLength(context);
