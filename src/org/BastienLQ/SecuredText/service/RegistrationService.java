...
import org.BastienLQ.SecuredText.push.SecuredTextCommunicationFactory;
...
public class RegistrationService extends Service {
  ...
  public static final String REGISTER_NUMBER_ACTION = "org.BastienLQ.SecuredText.RegistrationService.REGISTER_NUMBER";
  public static final String VOICE_REQUESTED_ACTION = "org.BastienLQ.SecuredText.RegistrationService.VOICE_REQUESTED";
  public static final String VOICE_REGISTER_ACTION  = "org.BastienLQ.SecuredText.RegistrationService.VOICE_REGISTER";

  public static final String NOTIFICATION_TITLE     = "org.BastienLQ.SecuredText.NOTIFICATION_TITLE";
  public static final String NOTIFICATION_TEXT      = "org.BastienLQ.SecuredText.NOTIFICATION_TEXT";
  public static final String CHALLENGE_EVENT        = "org.BastienLQ.SecuredText.CHALLENGE_EVENT";
  public static final String REGISTRATION_EVENT     = "org.BastienLQ.SecuredText.REGISTRATION_EVENT";
  ...
  private void handleVoiceRegistrationIntent(Intent intent) {
    ...
    try {
      TextSecureAccountManager accountManager = SecuredTextCommunicationFactory.createManager(this, number, password);
  ...
  private void handleSmsRegistrationIntent(Intent intent) {
    ...
    String       number       = intent.getStringExtra("e164number");
    MasterSecret masterSecret = intent.getParcelableExtra("master_secret");
    int          registrationId = SecuredTextPreferences.getLocalRegistrationId(this);

    if (registrationId == 0) {
      registrationId = KeyHelper.generateRegistrationId(false);
      SecuredTextPreferences.setLocalRegistrationId(this, registrationId);
    }
      ...
      throws IOException
  {
    ...
    SecuredTextPreferences.setGcmRegistrationId(this, gcmRegistrationId);
    SecuredTextPreferences.setWebsocketRegistered(this, true);
  ...
  private void markAsVerifying(boolean verifying) {
    SecuredTextPreferences.setVerifying(this, verifying);

    if (verifying) {
      SecuredTextPreferences.setPushRegistered(this, false);
    }
  }

  private void markAsVerified(String number, String password, String signalingKey) {
    SecuredTextPreferences.setVerifying(this, false);
    SecuredTextPreferences.setPushRegistered(this, true);
    SecuredTextPreferences.setLocalNumber(this, number);
    SecuredTextPreferences.setPushServerPassword(this, password);
    SecuredTextPreferences.setSignalingKey(this, signalingKey);
    SecuredTextPreferences.setSignedPreKeyRegistered(this, true);
  }
