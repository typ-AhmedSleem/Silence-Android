...
import org.BastienLQ.SecuredText.util.Trimmer;
...
public class StoragePreferenceFragment extends PreferenceFragment {
  ...
  public void onCreate(Bundle paramBundle) {
    ...
    this.findPreference(SecuredTextPreferences.THREAD_TRIM_NOW)
      .setOnPreferenceClickListener(new TrimNowClickListener());
    this.findPreference(SecuredTextPreferences.THREAD_TRIM_LENGTH)
  ...
  private class TrimNowClickListener implements Preference.OnPreferenceClickListener {
    ...
    public boolean onPreferenceClick(Preference preference) {
      final int threadLengthLimit = SecuredTextPreferences.getThreadTrimLength(getActivity());
  ...
  private class TrimLengthValidationListener implements Preference.OnPreferenceChangeListener {
    ...
    public TrimLengthValidationListener() {
      EditTextPreference preference = (EditTextPreference)findPreference(SecuredTextPreferences.THREAD_TRIM_LENGTH);
  ...
  public static CharSequence getSummary(Context context) {
    ...
    return context.getString(SecuredTextPreferences.isThreadLengthTrimmingEnabled(context) ? onCapsResId : offCapsResId);
  }
}
