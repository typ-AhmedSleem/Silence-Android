...
import org.BastienLQ.SecuredText.PassphraseChangeActivity;
...
public class AppProtectionPreferenceFragment extends PreferenceFragment {
  ...
  public void onCreate(Bundle paramBundle) {
    ...
    this.findPreference(SecuredTextPreferences.CHANGE_PASSPHRASE_PREF)
        .setOnPreferenceClickListener(new ChangePassphraseClickListener());
    this.findPreference(SecuredTextPreferences.PASSPHRASE_TIMEOUT_INTERVAL_PREF)
  ...
  public void onResume() {
    ...
    disablePassphrase.setChecked(!SecuredTextPreferences.isPasswordDisabled(getActivity()));
  }

  private void initializePlatformSpecificOptions() {
    PreferenceScreen preferenceScreen         = getPreferenceScreen();
    Preference       screenSecurityPreference = findPreference(SecuredTextPreferences.SCREEN_SECURITY_PREF);
  ...
  private void initializeTimeoutSummary() {
    int timeoutMinutes = SecuredTextPreferences.getPassphraseTimeoutInterval(getActivity());
    this.findPreference(SecuredTextPreferences.PASSPHRASE_TIMEOUT_INTERVAL_PREF)
  ...
  private class PassphraseIntervalClickListener implements Preference.OnPreferenceClickListener, HmsPickerDialogFragment.HmsPickerDialogHandler {
    ...
    public void onDialogHmsSet(int reference, int hours, int minutes, int seconds) {
      ...
      SecuredTextPreferences.setPassphraseTimeoutInterval(getActivity(), timeoutMinutes);
      initializeTimeoutSummary();
    }
  }
      ...
      if (((CheckBoxPreference)preference).isChecked()) {
        ...
        builder.setPositiveButton(R.string.ApplicationPreferencesActivity_disable, new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialog, int which) {
            ...
            SecuredTextPreferences.setPasswordDisabled(getActivity(), true);
  ...
  private static CharSequence getPassphraseSummary(Context context) {
    ...
    if (SecuredTextPreferences.isPasswordDisabled(context)) {
  ...
  private static CharSequence getScreenSecuritySummary(Context context) {
    ...
    if (SecuredTextPreferences.isScreenSecurityEnabled(context)) {
