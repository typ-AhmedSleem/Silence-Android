 ...
 */
package org.BastienLQ.SecuredText.notifications;
...
import org.BastienLQ.SecuredText.database.MmsSmsDatabase;
import org.BastienLQ.SecuredText.database.PushDatabase;
import org.BastienLQ.SecuredText.database.SmsDatabase;
...
import org.BastienLQ.SecuredText.util.SpanUtil;
...
public class MessageNotifier {
  ...
  public static void updateNotification(Context context, MasterSecret masterSecret) {
    if (!SecuredTextPreferences.isNotificationsEnabled(context)) {
      return;
    }
  ...
  private static void sendInThreadNotification(Context context) {
    try {
      if (!SecuredTextPreferences.isInThreadNotifications(context)) {
        return;
      }

      String ringtone = SecuredTextPreferences.getNotificationRingtone(context);
  ...
  {
    String ringtone              = SecuredTextPreferences.getNotificationRingtone(context);
    boolean vibrate              = SecuredTextPreferences.isNotificationVibrateEnabled(context);
    String ledColor              = SecuredTextPreferences.getNotificationLedColor(context);
    String ledBlinkPattern       = SecuredTextPreferences.getNotificationLedPattern(context);
    String ledBlinkPatternCustom = SecuredTextPreferences.getNotificationLedPatternCustom(context);
  ...
  private static void scheduleReminder(Context context, MasterSecret masterSecret, int count) {
    if (count >= SecuredTextPreferences.getRepeatAlertsCount(context)) {
      return;
    }
  ...
  public static class ReminderReceiver extends BroadcastReceiver {
    ...
    public static final String REMINDER_ACTION = "org.BastienLQ.SecuredText.MessageNotifier.REMINDER_ACTION";
  ...
  public static class DeleteReceiver extends BroadcastReceiver {
    ...
    public static final String DELETE_REMINDER_ACTION = "org.BastienLQ.SecuredText.MessageNotifier.DELETE_REMINDER_ACTION";
